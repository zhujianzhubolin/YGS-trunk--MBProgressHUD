...
-(void)creatTagUI:(UILabel *)tagLabel{
    ...
    tagLabel.textColor = self.tagTextColor?self.tagTextColor:[UIColor orangeColor];
    ...
    tagLabel.layer.borderColor = self.tagBorderColor?[self.tagBorderColor CGColor]:[[UIColor orangeColor] CGColor];
