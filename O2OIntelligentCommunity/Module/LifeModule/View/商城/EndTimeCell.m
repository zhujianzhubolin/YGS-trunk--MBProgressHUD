...

{
    ...
    __weak IBOutlet UILabel *miniuteLable;
    
    __weak IBOutlet UILabel *secondLable;
...
- (void)getLeftTime{
    ...
    if (lefth < 10) {
        hourLable.text = [NSString stringWithFormat:@"0%d",lefth];
        
    }else{
        hourLable.text = [NSString stringWithFormat:@"%d",lefth];
    }
    
    int leftm = leftMiniute%3600/60;
    
    if (leftm < 10) {
        miniuteLable.text = [NSString stringWithFormat:@"0%d",leftm];
        
    }else{
        miniuteLable.text = [NSString stringWithFormat:@"%d",leftm];
    }
    
    int lefts = leftMiniute%3600%60;
    
    if (lefts < 10) {
        secondLable.text = [NSString stringWithFormat:@"0%d",lefts];
    }else{
        secondLable.text = [NSString stringWithFormat:@"%d",lefts];
    }
}
