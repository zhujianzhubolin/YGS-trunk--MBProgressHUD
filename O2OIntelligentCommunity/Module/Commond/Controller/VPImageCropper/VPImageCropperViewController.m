...
- (void)initView {
    ...
    CGFloat originalImageScale = self.originalImage.size.height / self.originalImage.size.width;
    CGFloat cropScale = self.cropFrame.size.height / self.cropFrame.size.width;
    
    CGFloat oriHeight;
    CGFloat oriWidth;
    
    NSLog(@"originalImageScale = %f,cropScale = %f",originalImageScale,cropScale);
    if (originalImageScale < cropScale) {
