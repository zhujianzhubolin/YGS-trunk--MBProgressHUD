...
//顶部菜单点击的block
typedef void (^TopTabControlItemClickBlock)(UITableViewCell *cell,NSUInteger index);
//页面滑动结束后的block
typedef void (^TopTabControlPageEndDeceleratingBlock)(UITableViewCell *cell,NSUInteger index);
...
/** item点击回调 */
@property (nonatomic, strong) TopTabControlItemClickBlock itemClickBlock;

/** page滑动结束后的回调 */
@property (nonatomic, strong) TopTabControlPageEndDeceleratingBlock pageEndDeceleratingBlock;
...
/**
 *  重新刷新contentTable数据，类似UItableView的重新刷新数据
 */
