...
-(void)setImageDeselected:(NSString *)deselectedName halfSelected:(NSString *)halfSelectedName fullSelected:(NSString *)fullSelectedName andDelegate:(id<RatingBarDelegate>)delegate{
    ...
    starRating = 0.0;
    lastRating = 0.0;
    CGFloat sigleWidth = self.frame.size.height;
    ...
    [_s1 setFrame:CGRectMake(0,         0, sigleWidth, sigleWidth)];
    [_s2 setFrame:CGRectMake(sigleWidth,     0, sigleWidth, sigleWidth)];
    [_s3 setFrame:CGRectMake(2 * sigleWidth, 0, sigleWidth, sigleWidth)];
    [_s4 setFrame:CGRectMake(3 * sigleWidth, 0, sigleWidth, sigleWidth)];
    [_s5 setFrame:CGRectMake(4 * sigleWidth, 0, sigleWidth, sigleWidth)];
    ...
    frame.size.width = sigleWidth * 5;
    frame.size.height = sigleWidth;
    [self setFrame:frame];
}
...
- (void)changePostionForTouches:(NSSet *)touches {
    if (self.isIndicator) {
        return;
    }
...
-(void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    [self changePostionForTouches:touches];
}
