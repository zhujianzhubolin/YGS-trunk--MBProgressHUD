...
@interface ZYCommentDetailsVC ()<UITableViewDataSource,UITableViewDelegate,UMSocialUIDelegate,UIAlertViewDelegate,UIScrollViewDelegate>

@end

@implementation ZYCommentDetailsVC
{
