...
//
    ...
    //商户号，填写商户对应参数
    #define MCH_ID          @"1290334601"
    //商户API密钥，填写相应参数
    #define PARTNER_ID      @"bg8k9m1nf31i5b0c23jhe34o6f6a7d2v"

    #else//生产环境账号

    //商户号，填写商户对应参数
    #define MCH_ID          @"1259636801"
    //商户API密钥，填写相应参数
    #define PARTNER_ID      @"gdsznsqygs001como2ocommunityapps"
    ...
    //商户号，填写商户对应参数
    #define MCH_ID          @"1290327001"
    //商户API密钥，填写相应参数
    #define PARTNER_ID      @"p0m9n8n76vc0x9b6e2re1x0iwqo4bt3k"

    #else//生产环境账号

    //商户号，填写商户对应参数
    #define MCH_ID          @"1271748001"
    //商户API密钥，填写相应参数
    #define PARTNER_ID      @"gb9xf6b6d0nm240okx2b7nfdp0m9n8nb"
...
{
    //创建支付签名对象 && 初始化支付签名对象
    WeChatPayClass* wxpayManager = [[WeChatPayClass alloc]initWithAppID:APP_ID mchID:MCH_ID spKey:PARTNER_ID];
